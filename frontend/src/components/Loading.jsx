function Loading() {
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center overflow-hidden bg-[#020404]/80 backdrop-blur-xl">
            ...
            <div className="relative flex flex-col items-center rounded-[2rem] border border-white/10 bg-white/[0.03] px-10 py-10 shadow-[0_30px_80px_rgba(0,0,0,0.55)] backdrop-blur-xl">
                <div className="absolute inset-0 rounded-[2rem] bg-gradient-to-br from-cyan-500/10 via-transparent to-indigo-500/10"></div>
                ...
                <div className="relative mt-8 text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-400">
                        Preparing your collaboration dashboard...
                    </p>
                </div>
            </div>
        </div>
